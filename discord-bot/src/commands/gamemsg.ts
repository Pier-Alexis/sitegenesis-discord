...
type AnnouncementType = {
    id: "systemgenesis" | "sitedirector" | "o5" | "admin";
    label: string;
    radioUsername: string;
    permission: ServerMsgPermission;
};

const ANNOUNCEMENT_TYPES: ReadonlyArray<AnnouncementType> = [
    {
        id: "systemgenesis",
        label: "SystemGenesis",
...
function buildPromptContent(
    ...
    selectedServerLabel: string | null
) {
    return [
...
function buildTypeMenu(
    allowedTypes: ReadonlyArray<AnnouncementType>,
...
function buildServerMenu(
    serverDirectory: Map<string, ParsedServerCategory>,
...
export async function execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
        ...
        await interaction.editReply({
            content:
                selectedServerId === ALL_SERVERS_SENTINEL
